...
#elif PRUSA_SKR_FRAME_TYPE == 3 || PRUSA_SKR_FRAME_TYPE == 4 || PRUSA_SKR_FRAME_TYPE == 5
 ...
 */
#if !defined(PRUSA_SKR_FRAME_TYPE) || (PRUSA_SKR_FRAME_TYPE < 1 || PRUSA_SKR_FRAME_TYPE > 5)
  #error "PRUSA_SKR_FRAME_TYPE is invalid or not defined."
#elif PRUSA_SKR_FRAME_TYPE == 1 // Bear
  #define Z_MAX_POS 210
#elif PRUSA_SKR_FRAME_TYPE == 3 // Caribou 220
  #define Z_MAX_POS 220
#elif PRUSA_SKR_FRAME_TYPE == 4 || PRUSA_SKR_FRAME_TYPE == 2 // Tall Bear or Caribou 320
  #define Z_MAX_POS 320
#elif PRUSA_SKR_FRAME_TYPE == 5 // Caribou 420
 ...
 *           11: Dutch                   22: Polish
 */
#if !defined(PRUSA_SKR_LCD_LANGUAGE) || (PRUSA_SKR_LCD_LANGUAGE < 1 || PRUSA_SKR_LCD_LANGUAGE > 31)
...
#elif PRUSA_SKR_LCD_LANGUAGE == 29  // Turkish
  #define LCD_LANGUAGE tr
#elif PRUSA_SKR_LCD_LANGUAGE == 30  // Ukrainian
  #define LCD_LANGUAGE uk
#elif PRUSA_SKR_LCD_LANGUAGE == 31  // Vietnamese
